    ...
    <LoadingSpinner :loading="loading">
      <div class="card mb-3">
        <div class="card-body">
          ...
          <div class="mb-2">
            <textarea v-model="messageText" class="form-control" rows="3" placeholder="Scrivi un messaggio" />
          </div>
          <div class="d-flex align-items-center gap-2 mb-3">
            <input ref="attachmentInput" type="file" class="form-control form-control-sm" @change="onAttachmentChange">
            <span v-if="attachmentData" class="text-muted small">Allegato caricato</span>
          </div>
